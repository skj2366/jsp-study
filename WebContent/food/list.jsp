...
<form>
	음식이름 : <input type="text" name="food_name"> <br> 
	음식가격 : <input type="text" name="food_price"> <br>
	<button>검색</button>
</form>
<body>
	<%
	...
	<script>
		function foodDelete(foodNum) {
			var isDelete = confirm("진짜 삭제할까?");
			if (isDelete) {
				location.href = "/jsp-study/food/delete_ok.jsp?foodNum="
						+ foodNum;
			}
		}
	</script>
